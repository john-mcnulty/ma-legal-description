...
| **2** | **Plymouth** | Headless browser (Playwright/Chromium) against an ASP.NET WebForms site. Page images saved at the registry's 2000 px render; inline extraction on those images (v3.47). | ~30 s + one API call |
